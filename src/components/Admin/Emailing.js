    ...
    <SaveButton
      ...
      >
        Sauvegarder
            ...
            <EmailEditor ref={this.emailEditorRef} onLoad={email && this.onLoad(email[id]?.email?.design)}/>
        </>
        )}
            </>
        )
