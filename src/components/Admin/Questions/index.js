                      ...
                      >
                        ...
                        {items[
                          ...
                          >
                            ...
                            ]?.answers?.female[0]?.answers.map((item) => {
                              return (
                                <MenuItem
                                  key={item?.content}
                                  value={item?.content}
                            ...
                            ]?.answers?.female[1]?.answers.map((item) => {
                              return (
                                <MenuItem
                                  key={item?.content}
                                  value={item?.content}
                            ...
                            ]?.answers?.male[0]?.answers.map((item) => {
                              return (
                                <MenuItem
                                  key={item?.content}
                                  value={item?.content}
                            ...
                            ]?.answers?.male[1]?.answers.map((item) => {
                              return (
                                <MenuItem
                                  key={item?.content}
                                  value={item?.content}
